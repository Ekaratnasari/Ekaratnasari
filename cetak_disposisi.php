...
?>
	...
	<div class="row" align="center">
		<div class="header">
			...
			<h6 class="text">PEMERINTAH KABUPATEN TEGAL<br> UPTD DIKBUD KECAMATAN MARGASARI</h6>
			<h4></h4>
			<td colspan="3" bordered="#ffffff">
				<div align="center" style="border: solid; font-size: 10px;">
					Kecamatan Margasari Kabupaten Tegal Telp. (0283) 3466058
				</div>
			</td>
		</div>
		<br>
